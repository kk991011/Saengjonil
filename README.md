...
| `main.html` | 내 일지 | **본인의 생존 쿠폰 잔액·건별 만료일 조회 및 사용 항목·금액 직접 기록**, 오늘 기록(매십경·면·독·운 루틴 + 취준활동: **강의 수강[정해진 강의별 분 입력]**·자소서·필기·면접·지원), 대시보드(내 추이 + **조별 추이[내 조 선택기]**), 주차별 추이, 주간/월간 목표, 누적 요약, 프로필/테마 설정(+**이전 시즌 기록** 입력, 소속 조 읽기전용) |
