...
| `admin.html` | 관리자 | 전체 현황, **기간·조·프로그램별 MVP TOP 3/통계**, 그룹 CRUD, 유저 **닉네임 변경**·조 다중 배정(체크박스)·프로그램 변경·온보딩 초기화·삭제, **그룹 수정에서 조장 지정**, 유저 상세, **생존 쿠폰 개별 발급·회원 사용 내역 확인·취소·만료 내역 조회/삭제·검색·누적 통계** |
